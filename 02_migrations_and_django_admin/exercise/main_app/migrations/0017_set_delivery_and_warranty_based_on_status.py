# Generated by Django 5.0.4 on 2024-07-02 15:42
...
def reverse_set_delivery_and_warranty(apps, schema_editor):
    order_model = apps.get_model('main_app', 'Order')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            code=set_delivery_and_warranty,
            reverse_code=reverse_set_delivery_and_warranty,
        )
    ]
