# Generated by Django 5.0.4 on 2024-07-27 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starring_actor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='main_character_in_movies', to='main_app.actor')),
            ],
            options={
                'abstract': False,
            },
